...
    Collaboration dynamics can also be entirely different. Collaboration networks tend to follow a hierarchical structure, with scholars of a higher prestige potentially serving as mentors to scholars with lower prestige. Horta, Feng and Santos (2022) argue that collaboration between researchers with different levels of prestige offers benefits to junior and senior scholars alike, as well as to the university and the whole scientific field. As such, lower-prestige scholars would prefer to work with scholars of a higher prestige, so that they themselves can get a higher prestige as well, or so that the process of writing the paper goes more smoothly (xxx zie bronnen st, zoals li et al, perc 2010). This then follows the concept of a scale-free network, where it would mean that scholars with a high prestige hold important central position within the network. In a scale-free network then, these highly prestigious scholars function as hubs with the most connections. This leads to a second hypothesis: \
