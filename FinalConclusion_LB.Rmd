...
    The hypotheses were tested using two methods. First, two hypotheses were tested by analyzing network visualizations and estimating the degree centrality. The other hypotheses were tested by utilizing the RSiena package, which uses a Stochastic Actor-Oriented Model (SAOM). As the method of network visualization had to be performed before the RSiena models, hypotheses 2 and 3 were tested first. \
